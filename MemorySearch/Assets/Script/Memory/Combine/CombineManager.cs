...
public class CombineManager : MonoBehaviour
{
    ...
    [SerializeField] Color             buttonAvailableColor;
    [SerializeField] Color             buttonUnavailableColor;
    ...
    *******************************/
    ...
    void Awake()
    {
        ...
        buttonAvailableColor = combineButtonImage.color;
    }
    ...
    void CostUpdate(MemoryType combineMemory)
    {
        ...
        toCostUI.SetBatteryCount(toCost);
    ...
    void ButtonColorUpdate()
    {
        ...
        {
            combineButtonImage.color = buttonUnavailableColor;
            return;
        }
        ...
        if (toCost >= 0)
        {
            combineButtonImage.color = buttonAvailableColor;
        }
        else
        {
            combineButtonImage.color = buttonUnavailableColor;
