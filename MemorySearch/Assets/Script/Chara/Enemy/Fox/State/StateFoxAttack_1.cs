...
public class StateFoxAttack_1 : State
{
    ...
    protected override void OnUpdate()
    {
        ...
        if (!BehaviorAnimation.UpdateTrigger(ref Owner.animator, "Attack_1"))
        {
            return;
        }
    ...
    {
        //モーションが終了していたら待機へ
        if(BehaviorAnimation.IsPlayEnd(ref Owner.animator, "Attack_1"))
        {
    ...
    {
        Owner.animator.ResetTrigger("Attack_1");
